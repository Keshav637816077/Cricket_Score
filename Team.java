    ...
    public void listPlayers() {
        if (playerCount == 0) {
            ...
            for (int i = 0; i < playerCount; i++) {
                System.out.print(constant.SPACE);
                System.out.println((i + 1) + constant.DOT + players[i].getName() + constant.HYPHEN + players[i].getProfession());
            }
        }
    }

    //This method gets Player name from the user and stores in the Team.
